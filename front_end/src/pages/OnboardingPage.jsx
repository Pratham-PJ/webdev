...
const OnboardingPage = () => {
  ...
  // 🆕 Sync authUser → formState once it's loaded
  useEffect(() => {
    if (authUser) {
      setFormState({
  ...
  // ✅ Fallback if profilePic is still empty
  const handleSubmit = (e) => {
    ...
    if (!formState.profilePic) {
      ...
      updatedFormState.profilePic = `https://avatar.iran.liara.run/public/${idx}.png`;
      toast.success("Random profile picture auto-assigned!");
    }

    onboardingMutation(updatedFormState);
  };
